# Codex Local Handoff: PMBOT-REHEARSAL-011-REHEARSAL-READINESS-DASHBOARD-CARD-LOCAL-ONLY
...
Prepare a local PMBOT rehearsal readiness dashboard card for operator review.

## Instructions

- Inspect local PMBOT files under the allowed paths before editing.
- Add a deterministic local readiness dashboard card for rehearsal review.
