# Codex Local Handoff: PMBOT-REHEARSAL-019-REHEARSAL-FAILURE-AND-ROLLBACK-PLAYBOOK-LOCAL-ONLY
...
Prepare a local PMBOT rehearsal failure and rollback playbook for operator review.

## Instructions

- Inspect local PMBOT files under the allowed paths before editing.
- Add a deterministic local failure and rollback playbook for rehearsal control.
