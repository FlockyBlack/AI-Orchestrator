# Codex Local Handoff: PMBOT-REHEARSAL-002-REHEARSAL-MARKET-PACKET-SCHEMA-LOCAL-ONLY
...
Prepare a local PMBOT rehearsal market packet schema for operator review.

## Instructions

- Inspect local PMBOT files under the allowed paths before editing.
- Add a deterministic local schema for descriptive rehearsal market packets.
