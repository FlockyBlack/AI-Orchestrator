# Codex Local Handoff: PMBOT-REHEARSAL-009-REHEARSAL-VALIDATION-REPLAY-PACKET-LOCAL-ONLY
...
Prepare a local PMBOT rehearsal validation replay packet for operator review.

## Instructions

- Inspect local PMBOT files under the allowed paths before editing.
- Add a deterministic local validation replay packet for rehearsal review.
