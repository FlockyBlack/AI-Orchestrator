# Codex Local Handoff: PMBOT-REHEARSAL-012-REHEARSAL-MORNING-OPERATOR-CARD-LOCAL-ONLY
...
Prepare a local PMBOT rehearsal morning operator card for operator review.

## Instructions

- Inspect local PMBOT files under the allowed paths before editing.
- Add a deterministic local morning operator card for rehearsal review.
