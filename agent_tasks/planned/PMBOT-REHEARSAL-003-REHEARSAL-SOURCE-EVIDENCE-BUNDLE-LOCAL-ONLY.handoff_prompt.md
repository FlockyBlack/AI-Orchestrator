# Codex Local Handoff: PMBOT-REHEARSAL-003-REHEARSAL-SOURCE-EVIDENCE-BUNDLE-LOCAL-ONLY
...
Prepare a local PMBOT rehearsal source evidence bundle for operator review.

## Instructions

- Inspect local PMBOT files under the allowed paths before editing.
- Add a deterministic local source evidence bundle for rehearsal review.
