# Codex Local Handoff: PMBOT-REHEARSAL-017-REHEARSAL-FORBIDDEN-ACTION-SCAN-LOCAL-ONLY
...
Prepare a local PMBOT rehearsal forbidden action scan for operator review.

## Instructions

- Inspect local PMBOT files under the allowed paths before editing.
- Add a deterministic local forbidden action scan artifact for rehearsal review.
