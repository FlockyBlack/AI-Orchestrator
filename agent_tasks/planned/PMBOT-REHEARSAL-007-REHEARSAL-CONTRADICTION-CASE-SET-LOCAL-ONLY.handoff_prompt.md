# Codex Local Handoff: PMBOT-REHEARSAL-007-REHEARSAL-CONTRADICTION-CASE-SET-LOCAL-ONLY
...
Prepare a local PMBOT rehearsal contradiction case set for operator review.

## Instructions

- Inspect local PMBOT files under the allowed paths before editing.
- Add a deterministic local contradiction case set for rehearsal source review.
