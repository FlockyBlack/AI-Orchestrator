# Codex Local Handoff: PMBOT-REHEARSAL-014-REHEARSAL-SOURCE-QUALITY-LINKS-LOCAL-ONLY
...
Prepare local PMBOT rehearsal source quality links for operator review.

## Instructions

- Inspect local PMBOT files under the allowed paths before editing.
- Add deterministic local links between rehearsal artifacts and source quality records.
