# Codex Local Handoff: PMBOT-REHEARSAL-004-REHEARSAL-OPERATOR-APPROVAL-RECORD-LOCAL-ONLY
...
Prepare a local PMBOT rehearsal operator approval record for operator review.

## Instructions

- Inspect local PMBOT files under the allowed paths before editing.
- Add a deterministic local operator approval record for read-only rehearsal control.
