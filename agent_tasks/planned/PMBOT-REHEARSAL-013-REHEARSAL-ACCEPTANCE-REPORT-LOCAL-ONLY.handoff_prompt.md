# Codex Local Handoff: PMBOT-REHEARSAL-013-REHEARSAL-ACCEPTANCE-REPORT-LOCAL-ONLY
...
Prepare a local PMBOT rehearsal acceptance report for operator review.

## Instructions

- Inspect local PMBOT files under the allowed paths before editing.
- Add a deterministic local acceptance report for rehearsal review.
