...
def _write_074d_status(root: Path) -> None:
    _write_json(
        root / "risk_engine_v2_074d" / "latest_risk_engine_v2_074d_status.json",
        {
            ...
            "unknown_blocker_ids": ["account_balance_allowance"],
            "unknown_blocker_count": 1,
            "last_artifact_timestamp": GENERATED_AT,
            "latest_status_path": "pm_bot/trading_core/artifacts/risk_engine_v2_074d/latest_risk_engine_v2_074d_status.json",
