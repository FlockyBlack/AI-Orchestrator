...
def build_paper_strategy_evaluation_ledger(
    *,
    ...
    operator_intent_packet_status: str = "not_generated",
    ...
    ledger = {
        ...
        "operator_intent_packet_status": clean_text(operator_intent_packet_status),
...
def build_paper_strategy_evaluation_summary(
    *,
    ...
    summary = {
        ...
        "operator_intent_packet_status": clean_text(strategy_ledger.get("operator_intent_packet_status")),
...
def render_paper_strategy_evaluation_ledger_markdown(ledger: Mapping[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- Operator intent packet: `{ledger.get('operator_intent_packet_status')}`",
...
def render_paper_strategy_evaluation_summary_markdown(summary: Mapping[str, Any]) -> str:
    ...
    return "\n".join(
        [
            ...
            f"- Operator intent packet: `{summary.get('operator_intent_packet_status')}`",
