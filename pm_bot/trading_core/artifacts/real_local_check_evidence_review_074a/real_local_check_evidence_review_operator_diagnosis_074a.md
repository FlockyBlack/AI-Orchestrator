...
- status: `blocked_first_supervised_tiny_order_not_ready`
- diagnosis: L2 credentials/auth has 1 unresolved blocker(s) for the first supervised tiny order.
- evidence:
- `local_real_check_snapshot_073a` exists=true parsed=true status=`local_real_check_snapshot_recorded_live_blocked` path=`pm_bot/trading_core/artifacts/local_real_check_snapshot_073a/latest_local_real_check_snapshot_status_073a.json`
...
- status: `blocked_first_supervised_tiny_order_not_ready`
- diagnosis: account/balance/allowance has 2 unresolved blocker(s) for the first supervised tiny order.
- evidence:
- `local_real_check_snapshot_073a` exists=true parsed=true status=`local_real_check_snapshot_recorded_live_blocked` path=`pm_bot/trading_core/artifacts/local_real_check_snapshot_073a/latest_local_real_check_snapshot_status_073a.json`
- `local_real_check_bundle_072c` exists=true parsed=true status=`local_real_check_bundle_completed_with_blockers_live_blocked` path=`pm_bot/trading_core/artifacts/local_real_check_bundle_072c/latest_local_real_check_bundle_status_072c.json`
...
- status: `blocked_first_supervised_tiny_order_not_ready`
- diagnosis: signer/private-key diagnostic has 2 unresolved blocker(s) for the first supervised tiny order.
- evidence:
- `local_real_check_snapshot_073a` exists=true parsed=true status=`local_real_check_snapshot_recorded_live_blocked` path=`pm_bot/trading_core/artifacts/local_real_check_snapshot_073a/latest_local_real_check_snapshot_status_073a.json`
- `local_real_check_bundle_072c` exists=true parsed=true status=`local_real_check_bundle_completed_with_blockers_live_blocked` path=`pm_bot/trading_core/artifacts/local_real_check_bundle_072c/latest_local_real_check_bundle_status_072c.json`
...
- status: `blocked_first_supervised_tiny_order_not_ready`
- diagnosis: token selection has 1 unresolved blocker(s) for the first supervised tiny order.
- evidence:
- `local_real_check_snapshot_073a` exists=true parsed=true status=`local_real_check_snapshot_recorded_live_blocked` path=`pm_bot/trading_core/artifacts/local_real_check_snapshot_073a/latest_local_real_check_snapshot_status_073a.json`
...
- `operator_token_selection_packet_073b` exists=true parsed=true status=`selection_required` path=`pm_bot/trading_core/artifacts/operator_token_selection_packet_073b/latest_operator_token_selection_status_073b.json`
- blockers:
...
- status: `blocked_first_supervised_tiny_order_not_ready`
- diagnosis: selected-token payload readiness has 2 unresolved blocker(s) for the first supervised tiny order.
- evidence:
- `selected_token_payload_readiness_gate_073c` exists=true parsed=true status=`blocked_missing_selected_token` path=`pm_bot/trading_core/artifacts/selected_token_payload_readiness_gate_073c/latest_selected_token_payload_readiness_status_073c.json`
- `operator_token_selection_packet_073b` exists=true parsed=true status=`selection_required` path=`pm_bot/trading_core/artifacts/operator_token_selection_packet_073b/latest_operator_token_selection_status_073b.json`
- `first_order_market_token_resolver_070b` exists=true parsed=true status=`blocked_missing_token_id` path=`pm_bot/trading_core/artifacts/first_order_market_token_resolver_070b/latest_first_order_market_token_status_070b.json`
- blockers:
