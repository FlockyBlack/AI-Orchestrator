...
- Candidate index `0`
  ...
  Command: `python -m pm_bot.operator_runner.selected_candidate_artifact --market BTC --strategy tiny-momentum --dry-run --candidate-index 0`
- Candidate index `1`
  Market: `MicroStrategy sells any Bitcoin by December 31, 2026?`
  Outcome: `No`
  ...
  Command: `python -m pm_bot.operator_runner.selected_candidate_artifact --market BTC --strategy tiny-momentum --dry-run --candidate-index 1`
...
```powershell
python -m pm_bot.operator_runner.selected_candidate_artifact --market BTC --strategy tiny-momentum --dry-run --candidate-index N
```
...
- candidate_index_provided: `true`
- candidate_index_status: `valid`
- requested_candidate_available: `true`
- safe_cli_command: `python -m pm_bot.operator_runner.selected_candidate_artifact --market BTC --strategy tiny-momentum --dry-run --candidate-index 0`
