...
LIVE_CONNECTOR_BLOCKERS = (
    ...
    },
    {
        ...
        "blocker_category": "btc_market_analysis_not_yet_order_intent",
        "blocker_name": "BTC market analysis is not yet order intent",
        "severity": "critical",
        "required_future_task": "Build BTC market analysis to order-intent dry-run in a separate future task.",
        "current_status": "not_implemented",
        "why_it_blocks_live_execution": "This build does not convert BTC market data into a reviewed order intent.",
    },
    {
        "blocker_id": "PMBOT-LIVE-BLOCKER-047",
        "blocker_category": "authenticated_live_order_connector_still_disabled",
        "blocker_name": "authenticated live order connector still disabled",
        "severity": "critical",
        "required_future_task": "Design and approve the authenticated live connector boundary in a separate future task.",
        "current_status": "disabled",
