...
RUNNER = ROOT / "pm_bot" / "replay" / "run_adversarial_replay.py"
EXPECTED_JSON = ROOT / "pm_bot" / "replay" / "expected_adversarial_replay_report.v1.json"
EXPECTED_MD = ROOT / "pm_bot" / "replay" / "expected_adversarial_replay_report.v1.md"
...
class AdversarialReplayRunnerTests(unittest.TestCase):
    ...
    def test_runner_detects_or_rejects_false_positives(self):
