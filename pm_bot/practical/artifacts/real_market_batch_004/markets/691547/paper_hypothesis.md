# PMBOT Paper-Only Hypothesis

- Market ID: `691547`
- Market title: Kraken IPO by December 31, 2026?
- Analysis ID: `691547.analysis.56b3a68b9b94`
- Hypothesis ID: `691547.analysis.56b3a68b9b94.paper_hypothesis`
- Safety label: `paper_only_non_executable_analysis_tracking`
- Non-executable: true
- Real trade decision: false
...
- Paper-only, non-executable, analysis-quality tracking only.
- No orders, wallet access, authenticated endpoints, or real-money action.
