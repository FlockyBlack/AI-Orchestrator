...
def build_ru_snapshot(*, generated_at: str = GENERATED_AT) -> dict[str, Any]:
    ...
    return {
        ...
        "product_screens": {
            ...
            "pnl": [RU_BACK_LABEL],
            "limits": [RU_BACK_LABEL],
            "status": [RU_BACK_LABEL],
            "mini_app": [RU_BACK_LABEL],
            "stop": [RU_BACK_LABEL],
        },
...
def build_en_snapshot(*, generated_at: str = GENERATED_AT) -> dict[str, Any]:
    ...
    return {
        ...
        "product_screens": {
            ...
            "pnl": [EN_BACK_LABEL],
            "limits": [EN_BACK_LABEL],
            "status": [EN_BACK_LABEL],
            "mini_app": [EN_BACK_LABEL],
            "stop": [EN_BACK_LABEL],
        },
        "no_fake_balance": True,
        "no_fake_trades": True,
    ...
    *,
    ...
    return {
        ...
        "manual_verification": {
            ...
            "mini_app_url_behavior": "Configured PMBOT_TELEGRAM_MINI_APP_URL adds an Open PMBOT WebApp button; missing URL shows a clear fallback.",
        },
        "safety_statement": (
