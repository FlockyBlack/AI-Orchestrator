...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run PMBOT Risk Engine v2 review 074D.")
    ...
    parser.add_argument("--dry-run", action="store_true", help="Required. Writes no-live review artifacts.")
    parser.add_argument(
        "--artifacts-dir",
        "--artifact-dir",
        dest="artifacts_dir",
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print(render_risk_engine_v2_review_cli_summary(status))
    return 0
